...
class Track {
    ...
    private String formattedDuration(int totalSeconds) {
        ...
        int minutes = totalSeconds / 60; // compute the minute
        int seconds = totalSeconds % 60; // compute the second
        // format the string with two digit for second
        String formattedString = String.format("%02d" , seconds);
        String res = minutes + ":" + formattedString;
